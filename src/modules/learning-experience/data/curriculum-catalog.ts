...
export const publishedCurriculumLessons: CurriculumLessonMetadata[] = [
  ...
  { number: 4, title: "Foundation Models, Prompting & Context Engineering", description: "Understand foundation models, design effective prompts and context, evaluate model choices, and build an enterprise intelligence layer.", experienceCount: 6, status: "available", slug: "foundation-models-prompting-context-engineering", href: `${workshopRoute}/foundation-models-prompting-context-engineering` },
];
