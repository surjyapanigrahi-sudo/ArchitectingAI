...
export interface LessonCompletionSummary { narrative: string; takeaways: string[]; emphasis: string[]; }
export interface InstructionalVideo { src: string; title: string; description: string; durationLabel: string; }
...
export interface LearningLesson { id: EntityId; slug: string; workshopId: EntityId; title: string; description: string; part?: string; estimatedMinutes?: number; durationLabel?: string; status?: "in-development" | "published"; plannedExperienceCount?: number; instructionalVideo?: InstructionalVideo; experiences: LearningExperienceDefinition[]; lessonSummary?: LessonCompletionSummary; resources: LearningResource[]; glossary?: GlossaryTerm[]; }
