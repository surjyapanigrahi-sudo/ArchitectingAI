...
export function RegistrationForm() {
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const { data, error } = await supabase.auth.signUp({ email: values.email.trim(), password: values.password, options: { emailRedirectTo: `${getPublicSiteUrl()}/auth/confirm`, data: { full_name: values.fullName.trim() } } });
