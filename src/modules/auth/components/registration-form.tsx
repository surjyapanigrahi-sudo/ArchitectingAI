...
import { getPublicSiteUrl, getSafeAuthError } from "@/lib/supabase/config";
...
export function RegistrationForm({ returnToAssessment = false }: { returnToAssessment?: boolean }) {
